...
<body>
	...
	<form method="post" action="/product/imgupload"
		enctype="multipart/form-data">
		<div class="col-auto">
			<label for="formFile" class="form-label">Product Code : </label> 
			<input type="text" class="form-control" name="p_code" value="${p_code}" readonly>
			<br> 
				
			<label for="formFile" class="form-label">Select	a file : </label> 
			<input type="file" class="form-control" id="formFile" name="p_image"> 
			<br> 
